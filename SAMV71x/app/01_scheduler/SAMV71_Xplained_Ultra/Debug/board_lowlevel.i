# 1 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_lowlevel.c"
...
# 1 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_lowlevel.c"
# 40 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_lowlevel.c"
...
# 41 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_lowlevel.c" 2
# 66 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_lowlevel.c"
void _SetupMemoryRegion( void )
{
 ...
 dwRegionAttr =
  ( 0x01 << 24 ) |
  MPU_CalMPURegionSize(0x003FFFFFUL - 0x00000000UL) |
  ( 0x01 );

 MPU_SetRegion( dwRegionBaseAddr, dwRegionAttr);
# 98 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_lowlevel.c"
 dwRegionBaseAddr =
  0x00400000UL |
  ( 0x10 ) |
  ( 2 );
 ...
 dwRegionAttr =
  ( 0x06 << 24 ) |
  (( 0x04 << 19 ) | ( 1 << 17 ) | ( 1 << 16 ) | ( 0 << 18 )) |
  MPU_CalMPURegionSize(0x005FFFFFUL - 0x00400000UL) |
  ( 0x01 );

 MPU_SetRegion( dwRegionBaseAddr, dwRegionAttr);
# 118 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_lowlevel.c"
 dwRegionBaseAddr =
  0x20000000UL |
  ( 0x10 ) |
  ( 3 );
 ...
 dwRegionAttr =
  ( 0x01 << 24 ) |
  MPU_CalMPURegionSize(0x203FFFFFUL - 0x20000000UL) |
  ( 0x01 );
 ...
 dwRegionAttr =
  ( 0x03 << 24 ) |
  (( 0x04 << 19 ) | ( 1 << 17 ) | ( 1 << 16 ) | ( 0 << 18 )) |
  MPU_CalMPURegionSize(((0x20400000UL) + 0x3FFFF) - (0x20400000UL))
  | ( 0x01 );

 MPU_SetRegion( dwRegionBaseAddr, dwRegionAttr);
# 156 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_lowlevel.c"
 dwRegionBaseAddr =
  (((0x20400000UL) + 0x3FFFF) + 1) |
  ( 0x10 ) |
  ( 5 );
 ...
 dwRegionAttr =
  ( 0x03 << 24 ) |
  (( 0x04 << 19 ) | ( 1 << 17 ) | ( 1 << 16 ) | ( 0 << 18 )) |
  MPU_CalMPURegionSize((0x2045FFFFUL) - (((0x20400000UL) + 0x3FFFF) + 1)) |
  ( 0x01 );

 MPU_SetRegion( dwRegionBaseAddr, dwRegionAttr);
# 189 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_lowlevel.c"
 dwRegionBaseAddr =
  0x40000000UL |
  ( 0x10 ) |
  ( 6 );

 dwRegionAttr = ( 0x03 << 24 ) |
  ( 0x01 << 28 ) |
  (( 0x00 << 19 ) | ( 0 << 17 ) | ( 1 << 16 )) |
  MPU_CalMPURegionSize(0x5FFFFFFFUL - 0x40000000UL)
  |( 0x01 );
 ...
 dwRegionAttr =
  ...
  (( 0x00 << 19 ) | ( 0 << 17 ) | ( 0 << 16 )) |
  MPU_CalMPURegionSize(0x6FFFFFFFUL - 0x60000000UL) |
  ( 0x01 );
 ...
 dwRegionAttr =
  ( 0x03 << 24 ) |
  (( 0x04 << 19 ) | ( 0 << 17 ) | ( 1 << 16 ) | ( 1 << 18 )) |
  MPU_CalMPURegionSize(0x7FFFFFFFUL - 0x70000000UL) |
  ( 0x01 );
 ...
 dwRegionAttr =
  ( 0x03 << 24 ) |
  (( 0x00 << 19 ) | ( 0 << 17 ) | ( 0 << 16 )) |
  MPU_CalMPURegionSize(0x9FFFFFFFUL - 0x80000000UL) |
  ( 0x01 );
 ...
 dwRegionAttr =
  ...
  ( 0x01 << 28 ) |
  (( 0x00 << 19 ) | ( 0 << 17 ) | ( 1 << 16 )) |
  MPU_CalMPURegionSize(0xA01FFFFFUL - 0xA0100000UL) |
  ( 0x01 );
 ...
 ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SHCSR |= ((1UL << 16) | (1UL << 17)
     | (1UL << 18));


 MPU_Enable( ( 0x1 << 0) | ( 0x1 << 2 ));

 __DSB();__ISB();;
}
# 339 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_lowlevel.c"
extern __attribute__ ((weak)) void LowLevelInit( void )
{

 SystemInit();

 _SetupMemoryRegion();
# 362 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_lowlevel.c"
}
